{1. Descargar el programa ImperativoEjercicioClase3.pas y completar.
...
nomb re y edad. La carga finaliza con el numero de socio 0 y el arbol debe quedar ordenado por numero de socio. La informacion de cada socio debe generarse
aleatoriamente. }
